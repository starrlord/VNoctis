 ...
 * }} props
 */
export default function SortBar({ filteredCount, totalCount, sortBy, onSortChange, currentPage, pageSize, showAll, hiddenCount, showHidden, onToggleShowHidden, unmatchedCount = 0, buildingCount = 0, queuedCount = 0, onStatusClick }) {
  const sortOptions = [
  ...
  return (
    <div className="flex items-center justify-between">
      {/* Left: result count with page range + status pills */}
      <div className="flex items-center flex-wrap gap-y-2">
        ...
        {unmatchedCount > 0 && (
          <button
            ...
            className="inline-flex items-center gap-1.5 ml-2 px-3 py-1 rounded-full text-xs font-medium bg-orange-500/15 text-orange-400 ring-1 ring-orange-500/25 hover:bg-orange-500/25 transition-all duration-200"
        ...
        {buildingCount > 0 && (
          <button
            ...
            className="inline-flex items-center gap-1.5 ml-2 px-3 py-1 rounded-full text-xs font-medium bg-blue-500/15 text-blue-400 ring-1 ring-blue-500/25 hover:bg-blue-500/25 animate-pulse transition-all duration-200"
        ...
        {queuedCount > 0 && (
          <button
            ...
            className="inline-flex items-center gap-1.5 ml-2 px-3 py-1 rounded-full text-xs font-medium bg-yellow-500/15 text-yellow-400 ring-1 ring-yellow-500/25 hover:bg-yellow-500/25 transition-all duration-200"
